...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Request LeadFlow Access",
        description:
          "Create your account to join your internal CRM workspace. Only company staff are authorized.",
      };
    }

    return {
      id: "signin",
      title: "LeadFlow Login",
      description:
        "Log in to your LeadFlow workspace. Only internal company staff may access this system.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Efficient client management for internal teams.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Secure login, branded onboarding, and clear flows built for company staff only.
              </p>
            </div>
